...
import Logo from "@img/navLogo.svg";
import Login from "@img/login.png";
import Burger from "@img/sun-regular.svg"; // Assuming Burger is the sun icon for light mode
import Moon from "@img/moon-solid.svg"; // Assuming Moon is the moon icon for dark mode
import Search from "@img/search.svg";
